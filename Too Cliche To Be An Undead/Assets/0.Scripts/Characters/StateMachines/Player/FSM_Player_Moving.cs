...
public class FSM_Player_Moving : FSM_Base<FSM_Player, FSM_Player.E_PlayerState>
{
    ...
    protected override void EventsUnsubscriber(FSM_Player stateManager)
    {
        ...
        //owner.OnSkillInput -= owner.GetSkillHolder.StartSkilkl;
        //owner.OnAskForSkill -= stateManager.SwitchToSkill;
    ...
    public override void Setup(FSM_Player stateManager)
    {
        ...
        StateName = FSM_Player.E_PlayerState.Moving;
    }
