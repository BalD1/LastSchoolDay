...
public class FSM_Player : FSM_ManagerBase
{
    ...
    private Dictionary<E_PlayerState, FSM_Base<FSM_Player, E_PlayerState>> statesWithKey;
    ...
    private FSM_Base<FSM_Player, E_PlayerState> currentState;
    public FSM_Base<FSM_Player, E_PlayerState> CurrentState { get => currentState; }
    ...
    #region Switch
    private void SwitchState(FSM_Base<FSM_Player, E_PlayerState> state)
    {
    ...
    {
        statesWithKey.TryGetValue(newStateKey, out FSM_Base<FSM_Player, E_PlayerState> newState);
        SwitchState(newState);
    }

    public T SwitchState<T>(T newState) where T : FSM_Base<FSM_Player, E_PlayerState>
    {
        SwitchState(newState as FSM_Base<FSM_Player, E_PlayerState>);
        return currentState as T;
    }

    public T SwitchState<T>(E_PlayerState newStateKey) where T : FSM_Base<FSM_Player, E_PlayerState>
    {
    ...
    {
        statesWithKey.TryGetValue(state, out FSM_Base<FSM_Player, E_PlayerState> newState);
        SwitchState(newState);
    }
    public T ForceSetState<T>(E_PlayerState state) where T : FSM_Base<FSM_Player, E_PlayerState>
    {
    ...
    {
        statesWithKey = new Dictionary<E_PlayerState, FSM_Base<FSM_Player, E_PlayerState>>()
        {
