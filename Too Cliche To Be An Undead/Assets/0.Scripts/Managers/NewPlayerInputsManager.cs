...
public class NewPlayerInputsManager : PersistentSingleton<NewPlayerInputsManager>
{
    ...
    [field: SerializeField] public List<NewPlayerInputsHandler> PlayerInputsList { get; private set; }
    private List<InputDevice> knownDevices = new List<InputDevice>();
    public static NewPlayerInputsHandler P1Inputs
    {
        get
        {
    ...
    [SerializeField] private NewPlayerInputsHandler inputsPF;
    ...
    protected override void EventsSubscriber()
    {
        ...
        NewPlayerInputsHandlerEvents.OnPlayerInputsCreated += OnPlayerInputsCreated;
        NewPlayerInputsHandlerEvents.OnPlayerInputsDestroyed += OnPlayerInputsDestroyed;
    ...
    private void CheckIfP1Exist()
    {
        if (P1Inputs == null)
        {
            PlayerInputsList = new List<NewPlayerInputsHandler>();
            NewPlayerInputsHandler p1Inputs = inputsPF?.Create();
        }
    }
    ...
    private void PanelsActive() => NewPlayerInputsHandlerEvents.OnStart += OnAskedJoin;
    private void PanelsInactive() => NewPlayerInputsHandlerEvents.OnStart -= OnAskedJoin;
    ...
    private void OnPlayerInputsCreated(NewPlayerInputsHandler inputs)
    {
    ...
    private void OnAskedJoin(InputAction.CallbackContext context, NewPlayerInputsHandler inputs)
    {
        ...
        NewPlayerInputsHandler newInputs = inputsPF?.Create();
    ...
    public NewPlayerInputsHandler GetPlayerInputs(int idx)
    {
