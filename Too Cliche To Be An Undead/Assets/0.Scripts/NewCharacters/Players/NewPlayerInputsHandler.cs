...
public class NewPlayerInputsHandler : MonoBehaviourEventsHandler
{
    [field: ReadOnly, SerializeField] public NewPlayerCharacter Owner { get; private set; }
    ...
    public void SetOwner(NewPlayerCharacter character)
    {
        Owner = character;
        SwitchControlMapToInGame();
    }
    ...
    {
        this.OnMovementsInput?.Invoke(context.ReadValue<Vector2>());
    }
